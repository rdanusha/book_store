...
class __TwigTemplate_920eaa5d82b28fdb7ed26332a5eaf04e4f72289a9f04a6b82e183d37cf8b9cda extends Template
{
    private $source;
    private $macros = [];
...
{% macro render_bus_messages(messages, showBus = false) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "/mnt/b4e33210-d0d5-464b-bd55-b75dd455ba8d/book_store/vendor/symfony/web-profiler-bundle/Resources/views/Collector/messenger.html.twig");
    }
}

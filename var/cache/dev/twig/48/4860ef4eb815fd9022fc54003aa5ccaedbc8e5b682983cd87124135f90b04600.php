...
class __TwigTemplate_f7870a8ac8b2832373a686168b489c77c63adfe349fc254f7d2290541002790e extends Template
{
    private $source;
    private $macros = [];
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/mnt/b4e33210-d0d5-464b-bd55-b75dd455ba8d/book_store/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}

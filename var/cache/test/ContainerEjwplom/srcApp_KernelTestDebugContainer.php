...
class srcApp_KernelTestDebugContainer extends Container
{
    ...
    protected function getCartControllerService()
    {
        ...
        $this->services['App\\Controller\\CartController'] = $instance = new \App\Controller\CartController(($this->privates['App\\Repository\\CartRepository'] ?? $this->getCartRepositoryService()));
    ...
    protected function getShopControllerService()
    {
        ...
        $this->services['App\\Controller\\ShopController'] = $instance = new \App\Controller\ShopController(($this->privates['App\\Repository\\CartRepository'] ?? $this->getCartRepositoryService()));

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\ShopController', $this));
    ...
    protected function getTest_PrivateServicesLocatorService()
    {
        return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.mLFKcdw', 'get_ServiceLocator_MLFKcdwService', false],
    ...
    /**
     * Gets the private '.errored..service_locator.lJnrlVD.App\Entity\CartItem' shared service.
     *
     * @return \App\Entity\CartItem
     */
    protected function getCartItemService()
    {
        $this->throw('Cannot autowire service ".service_locator.lJnrlVD": it references class "App\\Entity\\CartItem" but no such service exists.');
    }
    ...
    /**
     * Gets the private '.service_locator.8K7JrKe' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_8K7JrKeService()
    {
        return $this->privates['.service_locator.8K7JrKe'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'cart' => ['privates', 'App\\Repository\\CartRepository', 'getCartRepositoryService', false],
            'product' => ['privates', 'App\\Repository\\ProductRepository', 'getProductRepositoryService', false],
        ], [
    ...
    /**
     * Gets the private '.service_locator.lIEwMrA' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_LIEwMrAService()
    {
        return $this->privates['.service_locator.lIEwMrA'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'products' => ['privates', 'App\\Repository\\ProductRepository', 'getProductRepositoryService', false],
        ], [
    ...
    /**
     * Gets the private '.service_locator.lJnrlVD' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_LJnrlVDService()
    {
        return $this->privates['.service_locator.lJnrlVD'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'cart_item' => ['privates', '.errored..service_locator.lJnrlVD.App\\Entity\\CartItem', NULL, 'Cannot autowire service ".service_locator.lJnrlVD": it references class "App\\Entity\\CartItem" but no such service exists.'],
        ], [
            'cart_item' => 'App\\Entity\\CartItem',
        ]);
    }

    /**
     * Gets the private '.service_locator.mLFKcdw' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_MLFKcdwService()
    {
        return $this->privates['.service_locator.mLFKcdw'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\CartController::delete' => ['privates', '.service_locator.lJnrlVD', 'get_ServiceLocator_LJnrlVDService', false],
            'App\\Controller\\CartController::new' => ['privates', '.service_locator.8K7JrKe', 'get_ServiceLocator_8K7JrKeService', false],
            'App\\Controller\\ShopController::index' => ['privates', '.service_locator.lIEwMrA', 'get_ServiceLocator_LIEwMrAService', false],
            'App\\Controller\\CartController:delete' => ['privates', '.service_locator.lJnrlVD', 'get_ServiceLocator_LJnrlVDService', false],
            'App\\Controller\\CartController:new' => ['privates', '.service_locator.8K7JrKe', 'get_ServiceLocator_8K7JrKeService', false],
            'App\\Controller\\ShopController:index' => ['privates', '.service_locator.lIEwMrA', 'get_ServiceLocator_LIEwMrAService', false],
        ], [
    ...
    protected function getCartItemRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\CartItemRepository'] = new \App\Repository\CartItemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cU7TQILhkc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('iJDMyAvSsO', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.easyadmin.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FhhYMhpOZr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UarufYx3fr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('x8eFTz-tyd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('M13Cv4kR6Q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hwm0wKaKJV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('adWj7tzS5M', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedController_InnerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller.inner'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.mLFKcdw'] ?? $this->get_ServiceLocator_MLFKcdwService()));
    }
    ...
    protected function getDebug_ArgumentResolver_Service_InnerService()
    {
        ...
        return $this->privates['debug.argument_resolver.service.inner'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(($this->privates['.service_locator.mLFKcdw'] ?? $this->get_ServiceLocator_MLFKcdwService()));
    }
                    ...
                    'Product' => [
                        ...
                        'list' => [
                            ...
                            'fields' => [
                                ...
                                4 => 'quantity',
                                5 => [
                                    'property' => 'product_category.name',
                                    'label' => 'Category',
                                ],
                            ],
                        ],
